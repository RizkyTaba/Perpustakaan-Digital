export class BookForm {
        ...
        <div class="card form-card glassy">
            <div class="card-body">
              ...
              <form id="book-form">
                ...
                <div class="mb-3">
                  <label for="author" class="form-label">Deskripsi Buku</label>
                  <input type="text" class="form-control rounded-pill" id="description" placeholder="Deskripsi Buku" required>
                </div>
                <div class="mb-3">
  ...
  resetForm() {
    ...
    document.getElementById("description").value = ""; // Reset deskripsi juga
  }
